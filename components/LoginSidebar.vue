	...
	>
		...
		<v-row class="justify-center">
			<v-col cols="auto">
				...
				<p class="text-center">
					<nuxt-link id="register" @click.native="openRegister" class="" to="">
						Incribirse
					</nuxt-link>
				</p>
			</v-col>
...
<script>
import BtnFacebookLogin from './BtnFacebookLogin.vue';
import BtnGoogleLogin from './BtnGoogleLogin.vue';
